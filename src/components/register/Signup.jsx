...
const SignUpForm = ({ buttonClasses, buttonForGFT }) => {
    ...
    const handleSubmit = async (e) => {
     e.preventDefault();
         // Expand formData to include new fields (if you submit them)
     const formData = { mobileNo, password, location, username, email };
         try {
  ...
  return (
    <div className="w-[460px] opacity-75 rounded-lg shadow-xl  border border-gray-100">
      <div className="p-6 space-y-6 ">
        ...
        <p className="text-sm text-center text-white mt-4 border-t border-gray-100 pt-4">
