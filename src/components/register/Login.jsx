...
const SignInForm = ({ buttonClasses, buttonForGFT }) => {
  ...
  return (
    <div className="w-full rounded-lg shadow-xl md:mt-0 sm:max-w-md xl:p-0 border opacity-75 border-gray-100">
      <div className="p-6 space-y-6 md:space-y-7 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6" action="#">
